    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          <span>
            I am a BCA student with a passion for Cyber Security and Web
            Development. Skilled in HTML, CSS, JavaScript, Mern and Java
            programming, Let's connect and create something amazing together!
          </span>
        </div>
        <Link to="contact" className="btn" smooth={true} spy={true}>
          <button className="button i-button">Hire me</button>
        </Link>
        {/* social icons */}
        <div className="i-icons">
          <a href="https://www.linkedin.com/in/sanjay1393/" target="_blank">
            <FaLinkedinIn size={80} />
          </a>
